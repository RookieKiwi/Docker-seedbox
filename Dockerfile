...
RUN \
    ...
    mkdir /app/jackett && cd /tmp && wget https://github.com/Jackett/Jackett/releases/download/v0.20.709/Jackett.Binaries.LinuxAMDx64.tar.gz-O /tmp/jackett.tgz && \
 ...
 RUN \
    ...
    wget https://github.com/Radarr/Radarr/releases/download/v4.0.5.5981/Radarr.master.4.0.5.5981.linux-core-x64.tar.gz -O radarr.tgz && \
    tar -xvzf radarr.tgz && \
